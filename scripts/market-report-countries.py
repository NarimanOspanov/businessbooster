...
S.append(table(
    ...
    [["Узбекистан", "37,5", "≈ 9 000", "24", "Госкомстат и Минздрав РУз, конец 2024"],
     ["Казахстан", "20,3", "≈ 3 800", "19", "справочник medelement: 2 173 стоматологии<br/>+ 1 658 медцентров"],
...
S.append(Paragraph("* по Кыргызстану — только Бишкек, на его собственное население. "
                   ...
                   "к одной методике: узбекское — государственный учёт, российское — "
                   "отраслевое исследование сетевых клиник, казахстанское — счётчик "
                   "коммерческого справочника. Сравнивать их можно по порядку величины, "
                   "но не как точные измерения.", st["small"]))

S.append(Spacer(1, 5 * mm))
S.append(bars([("Узбекистан", 24), ("Казахстан", 19), ("Россия", 9), ("Кыргызстан", 8)],
...
S.append(Paragraph("<b>Казахстан — самый понятный нам рынок.</b> Частная медицина держит "
                   "35% рынка медуслуг, страна двуязычная, телефония и номера у нас уже "
                   "проверены на живых звонках. Плотность клиник — вторая после "
                   "Узбекистана.", st["p"]))
