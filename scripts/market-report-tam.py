...
DATA = [("Казахстан", 3800, 50, 0.60), ("Узбекистан", 9000, 35, 0.60),
...
S.append(tbl(["Допущение", "Значение", "Откуда"],
  [["Клиник в стране", "3 800 / 9 000 / 13 200 / 300",
    "предыдущий отчёт по четырём странам"],
...
S.append(Paragraph("<b>Казахстан — 46 клиник.</b> Это то, ради чего сейчас идёт работа: "
                   "1,15 млн ₸ в месяц, 13,8 млн в год, из них около 8,5 млн валовой "
                   "прибыли. Один продавец, закрывающий четыре клиники в месяц, приходит "
                   "к этому за год. Цифра не выглядит фантастикой — и в этом её ценность.", st["p"]))
S.append(Paragraph("<b>Узбекистан вдвое больше Казахстана</b> — 108 клиник и 1,9 млн ₸ "
                   "в месяц даже при более низком счёте. Причина простая: клиник там "
                   "втрое больше, и 91% стоматологии — частная.", st["p"]))
...
S.append(Paragraph("<b>Числа клиник — нижние границы.</b> Справочники недосчитывают: по "
                   "Костанаю мы видели разницу в треть между двумя источниками. Значит "
                   "TAM скорее занижен, чем завышен.", st["p"]))
